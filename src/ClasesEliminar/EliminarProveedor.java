...
public void ProveedorEliminar(String id_proveedor, String valor, String filtro, JTable tablacontactos){
...
if(JOptionPane.OK_OPTION==confirmar) { 
 ...
 try { 
       con = conecta.Conectar();
        String Ssql = "DELETE FROM proveedores  "
                    + "WHERE id_proveedor= ?";
        
        PreparedStatement prest = con.prepareStatement(Ssql); 
         
        prest.setString(1, id_proveedor);
