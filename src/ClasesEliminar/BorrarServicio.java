...
public void ServicioEliminar(String id_servicio, String valor, String filtro, JTable tablacontactos){
...
if(JOptionPane.OK_OPTION==confirmar) { 
 ...
 try { 
       con = conecta.Conectar();
        String Ssql = "DELETE FROM servicios  "
                    + "WHERE id_servicio= ?";
        
        PreparedStatement prest = con.prepareStatement(Ssql); 
         
        prest.setString(1, id_servicio);
